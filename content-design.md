...
┌─────────────────────────────────────────────────────────────────────────────┐
│                           1. HEADER & NAVIGATION                             │
│   [Logo: Ω MPEO]   About   Accomplishments   Journey   Format   Topics   Team│ [Join at LifeCon]
├─────────────────────────────────────────────────────────────────────────────┤
│                    2. INTRO SPLASH & PARALLAX HERO                          │
│   • Cinematic Typography Intro ("MODEL PHILOSOPHY ETHICS OLYMPIAD")         │
│   • Kinetic Text Fall & Dissolve into Sticky Nav                            │
...
├─────────────────────────────────────────────────────────────────────────────┤
│            5. THE ROAD TO GRAND FINALS (VISUAL JOURNEY TIMELINE)            │
...
│   • Milestone 4: The International Grand Finals (Global Championship)       │
│   • Milestone 5: 2027 Senior Ethics Olympiad (Your Stage!)                  │
├─────────────────────────────────────────────────────────────────────────────┤
│            6. ANATOMY OF A MATCH (DEMYSITFYING THE 4-STEP ROUND)            │
...
- **Three Award Showcases**:
  ...
  3. 🌐 **Special Invitation: The International Grand Finals**
     - *Following our stellar regional performance, our team earned an official bid to the International Grand Finals to represent our school against champion schools worldwide.*

---

### Section 5: The Road to Grand Finals (Visual Journey Timeline)
...
- **Timeline Milestones**:
  ...
  4. 🌐 **Phase 4: The International Grand Finals (Summer 2026)**  
     *Invited to the highest echelon of competitive ethics, matching wits with global regional winners on the world stage.*
  5. 🚀 **Phase 5: The 2027 Senior Ethics Olympiad (Your Opportunity!)**  
     *If you join MPEO at LifeCon, you will train directly alongside our medalists and represent our school on the 2027 competition roster.*

---

### Section 6: Anatomy of a Match (Demystifying the 4-Step Round)
